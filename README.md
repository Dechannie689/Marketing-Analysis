...
|-------|-------------------|
| Source | Instagram, Pinterest, YouTube, LinkedIn (CSV exports), SharePoint (Contact Forms) |
| Ingestion | Microsoft Fabric Pipeline, Dataflow |
| Storage (Bronze) | Microsoft Fabric Lakehouse (OneLake) |
| Processing | PySpark Notebooks (data quality scoring, cleansing, transformation) |
| Storage (Silver / Gold) | Microsoft Fabric Lakehouse — Master Files |
| Semantic Layer | Power BI Semantic Model (Import + DirectQuery) |
| Orchestration | Microsoft Fabric Pipeline (Build & Automate) |
| Governance | Azure Active Directory, Azure Key Vault, Microsoft Purview, Azure Monitor |
| BI / Reporting | Power BI — multi-page dashboard |
